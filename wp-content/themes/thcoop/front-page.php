...
<div class="row">
	<div class="large-12 medium-8 small-centered columns">
			<a href="http://localhost/lacoop/?page_id=47" class="mybutton text-center">Je découvre</a>
	</div>
...
<section class="homeagenda">
	<div class="row rowagenda">
		...
		<div class="large-9 medium-7 small-12 columns">
				<a href="http://localhost/lacoop/?page_id=72" class="mybuttonblack">Voir l'agenda complet</a>
		</div>
	</div>
...
<section class="homearticle">
	...
	<div class="row rowactualite">
		...
		<div class="large-10 medium-8 small-12 columns">
				<a href="http://localhost/lacoop/?cat=3" class="mybutton">Voir les actualités</a>
		</div>
	</div>
